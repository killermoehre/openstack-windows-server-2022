...
$windowsImageMount = Mount-DiskImage -ImagePath "$PWD\SERVER_EVAL_x64FRE_en-us.iso" -PassThru
$windowsImageDriveLetter = ($windowsImageMount | Get-Volume).DriveLetter
$virtioImageMount = Mount-DiskImage -ImagePath "$PWD\virtio-win-0.1.240.iso" -PassThru
